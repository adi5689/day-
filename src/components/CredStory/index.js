      ...
      <div className="max-width flex story-wrapper">
        ...
        <div className="story-desc">
          ...
          <div className="story-para">
            ...
            So proud of how you have grown as a lady and also how you made me a better man. And honestly if I&apos;ll say, you&apos;re <strong>&apos;Monica&apos;</strong> to my <strong>&apos;Chandler&apos;</strong>, my <strong>&apos;Happy Place&apos;</strong>, my <strong>&apos;Sukoon&apos;</strong>, my <strong>&apos;Home&apos;</strong>.
          </div>
          <div className="story-para">
